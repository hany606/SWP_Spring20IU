...
class TutorialRunning2 extends StatefulWidget {
  @override
  _TutorialRunning2State createState() => _TutorialRunning2State();
}

class _TutorialRunning2State extends State<TutorialRunning2> {
  ...
  void _onArCoreViewCreated(ArCoreController controller) {
    // Connect to the db
    // Db db = new Db("mongodb://192.168.0.103:27017/");
    // var db_app = db.collection('arapp');
    // await db.open();
    // await db_app.find().forEach(
    //   _addInList
    // )
  ...
  void _addInList(Map presentation){
    print(presentation.toString());
  }
}
