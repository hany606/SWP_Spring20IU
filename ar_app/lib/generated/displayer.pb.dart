...
class Empty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Empty', package: const $pb.PackageName('displayer'), createEmptyInstance: create)
...
class Index extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Index', package: const $pb.PackageName('displayer'), createEmptyInstance: create)
...
class Slide extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Slide', package: const $pb.PackageName('displayer'), createEmptyInstance: create)
...
class Tutorial extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Tutorial', package: const $pb.PackageName('displayer'), createEmptyInstance: create)
    ..aOS(1, 'name')
...
class TutorialInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TutorialInfo', package: const $pb.PackageName('displayer'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..aOS(2, 'id', protoName: '_id')
    ..a<$core.int>(3, 'length', $pb.PbFieldType.O3)
    ..aOS(4, 'imgDataStr')
...
class TutorialsList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('TutorialsList', package: const $pb.PackageName('displayer'), createEmptyInstance: create)
